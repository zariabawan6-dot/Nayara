      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/shop" className={linkClass}>Stitched Suits</Link>
              </li>
              <li>
                <Link to="/shop" className={linkClass}>Unstitched Fabrics</Link>
              </li>
              <li>
                <Link to="/shop" className={linkClass}>Sale Items</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex space-x-6">
            ...
            <a href="https://www.tiktok.com/@nayarazone" target="_blank" rel="noopener noreferrer" aria-label="TikTok">
...
//                 <span>nayarazone36@gmail.com</span>
//               </p>
//               <p className="flex items-start">
